...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      ...
      <footer className="mx-auto max-w-6xl px-6 pb-10 text-sm text-white/40">
        <div className="border-t border-white/10 pt-6 flex flex-col md:flex-row md:justify-between gap-3">
          <span>© {new Date().getFullYear()} thezxcvbnm.online</span>
